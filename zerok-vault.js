              ...
              <div class="content-toolbar">
                ...
                <div class="toolbar-right">
                  ...
                  <div class="view-toggle">
                    ...
                    <button class="view-btn ${this.viewMode === 'details' ? 'active' : ''}" data-view="details">≡</button>
                    <button class="view-btn ${this.viewMode === 'gallery' ? 'active' : ''}" data-view="gallery">🖼️</button>
                    <button class="view-btn ${this.viewMode === 'analytics' ? 'active' : ''}" data-view="analytics">📊</button>
                  </div>
                </div>
              </div>
